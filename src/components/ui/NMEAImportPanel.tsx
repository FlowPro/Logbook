...
/** Compact "NMEA übernehmen" button — drop-in alongside GPS / copy buttons */
  ...
  if (connected) {
    ...
    return (
      <span className="flex items-center gap-1.5 text-xs text-green-600 dark:text-green-400">
        ...
        <span className="truncate">{parts.length ? parts.join(' · ') : 'Warte auf Daten…'}</span>
      </span>
    )
  }
  ...
  return (
    <div className="flex items-center gap-3 p-3 rounded-xl bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold text-green-900 dark:text-green-100">NMEA verbunden</p>
